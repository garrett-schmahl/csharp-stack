...
class SinglyLinkedList {
   ...
   */
  insertAtBack(data) {
    const newBack = new Node(data); //create node to contain data
    ...
    while (runner.next !== null) {
      runner = runner.next;
    } //iterate until null is found

    runner.next = newBack; //change the next property of that node to point to newly created node
    return this;
  }
