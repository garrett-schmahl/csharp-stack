...
class SinglyLinkedList {
  ...
  insertAtBackExceptRecursive(data, runner = this.head) {
    if (runner.next === null) {
      const newBack = new Node(data);
      runner.next = newBack;
      return this;
    }
    return this.insertAtBackExceptRecursive(data, runner.next);
  }
...
biNodeList.insertAtBackExceptRecursive(2).print();
